...
<section class="py-5 bg-image overlay-primary fixed overlay" id="next-section" style="background-image: url('<?= base_url('public/assets/images/hero_1.jpg') ?>');">
    <div class="container">
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 mb-5 mb-lg-0">
                <a data-fancybox data-ratio="2" href="https://vimeo.com/317571768" class="block__96788">
                    ...
                    <img src="<?= base_url('public/assets/images/sq_img_6.jpg') ?>" alt="Image" class="img-fluid img-shadow">
                </a>
            </div>
...
<section class="site-section">
    <div class="container">
        ...
        <div class="row align-items-center block__69944">
            <div class="col-md-6">
                <img src="<?= base_url('public/assets/images/person_5.jpg') ?>" alt="Image" class="img-fluid mb-4 rounded">
            </div>
            <div class="col-md-6">
