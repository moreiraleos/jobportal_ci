<?php $this->extend('layout/app.php'); ?>
...
<section class="section-hero overlay inner-page bg-image" style="background-image: url('<?= base_url('public/assets/images/hero_1.jpg') ?>');" id="home-section">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <h1 class="text-white font-weight-bold">Jobs in Category</h1>
                <div class="custom-breadcrumbs">
                    <a href="<?= url_to("home"); ?>">Home</a> <span class="mx-2 slash">/</span>
                    <span class="text-white"><strong>Jobs in Category</strong></span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row mb-5 justify-content-center">
            <div class="col-md-7 text-center">
                <h2 class="section-title mb-2">We have <?= count($jobsByCategory); ?> jobs in <?= $category->name ?> category</h2>
            </div>
        </div>
