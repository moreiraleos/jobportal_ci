        ...
        <div class="col">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="p-4 p-md-5" <?= url_to("jobs.store") ?> method="post" enctype="multipart/form-data">
                        <!--job details-->
                        ...
                        <div class="form-group">
                            ...
                            <select required name="category" class="selectpicker border rounded form-control " id="" data-style="btn-black" data-width="100%" data-live-search="true" title="Select Category">
